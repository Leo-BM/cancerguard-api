...
### Status do Deploy (projeto finalizado)

| Serviço | Plataforma | Status |
|---|---|---|
| FastAPI (backend) | Render — free tier, Docker runtime | ✅ Em produção |
| Streamlit (frontend) | Streamlit Community Cloud | ✅ Em produção |
| CI/CD | GitHub Actions (job test + deploy) | ✅ Ativo |
